    ...
    <>
      <div className="mini-card">
        ...
        <div className="footer-main-card-mt-2">
          ...
          <Link className="Link--muted d-inline-block" to="/">
            <svg
              aria-label="star"
              role="img"
              viewBox="0 0 16 16"
            ...
            <span className="Link-muted-inner-txt">631</span>
          </Link>
          ...
          <span className="collaborator-d-inline-block d-inline-block">
            <span className="collaboration-built-by d-img-inline-block">Built by</span>
            <Link to="/" className="d-img-inline-block">
              <img
                className="avatar avatar-user"
                src="https://avatars.githubusercontent.com/u/951738?s=40&amp;v=4"
                width="20"
                height="20"
                alt="@madMAx43v3r"
              />
          ...
          >
            ...
            <span className="star-today">262 stars today</span>
          </span>
